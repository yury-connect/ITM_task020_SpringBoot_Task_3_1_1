...
CREATE DATABASE itm_task017_spring_task_2_2_1_db;            -- Создаю базу если она еще не существует;

CREATE USER user1 WITH PASSWORD '1234';                                         -- Создаем пользователя с паролем

GRANT ALL PRIVILEGES ON DATABASE itm_task017_spring_task_2_2_1_db TO user1;  -- Даём пользователю права на базу данных
